...
title: C++ Primer
date: '2020-11-30'
tags: ['cpp', 'learn', 'c++ primer']
draft: false
summary: '阅读 C++ Primer 的笔记.'
---
...
10. <a id="r10" href="https://stackoverflow.com/questions/411103/function-with-same-name-but-different-signature-in-derived-class-not-found#:~:text=If%20the%20resulting%20set%20of%20declarations%20are%20not%20all%20from%20sub%2Dobjects%20of%20the%20same%20type%2C%20or%20the%20set%20has%20a%20nonstatic%20member%20and%20includes%20members%20from%20distinct%20sub%2Dobjects%2C%20there%20is%20an%20ambiguity%20and%20the%20program%20is%20ill%2Dformed.%20Otherwise%20that%20set%20is%20the%20result%20of%20the%20lookup.">Function with same name but different signature in derived class not found [answer: 411112]</a>
